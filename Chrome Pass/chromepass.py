...
root = tkinter.Tk()
root.title("Chrome Password Retriever By Jelmar Orapa")
...
def readchromepass():
        ...
        chromepass = f.read()
        my_textbox.insert(END, chromepass)
        f.close()

#creating a textbox for the subprocess output
my_textbox = Text(root, width=70, height=11, font=("Arial", 10))
my_textbox.pack(pady=10, padx=10)

#creating a button
readbutton = tkinter.Button(root, text="Retrieve Chrome Passwords!", bg=bg_colour, fg="white", font='Arial 12 bold', command= lambda:[main(), readchromepass()])
